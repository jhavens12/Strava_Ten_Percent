...
def top_period(dictionary):
    ...
    label1= v['label1']
    label1.text = (get_time.convert_weekday_full(next(iter(final_dict))) + " - " + get_time.convert_weekday_full(next(iter(final_dict))))
...
def current_period(dictionary):
    ...
    label7= v['label7']
    label7.text = (get_time.weekday(get_time.LM(0)) + " " + str(get_time.LM(0).day) + " - " + get_time.weekday(get_time.now()) + " " + str(get_time.now().day))
    ...
    #remaining
def remaining_period(dictionary):
